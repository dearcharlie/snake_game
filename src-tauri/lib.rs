...
#[tauri::command]
fn start_game(state: tauri::State<'_, mobile::AppState>) -> GameState {
    state.0.lock().unwrap().restart();
    state.0.lock().unwrap().get_state()
}

#[tauri::command]
fn get_game_state(state: tauri::State<'_, mobile::AppState>) -> GameState {
    state.0.lock().unwrap().get_state()
}

#[tauri::command]
fn set_direction(state: tauri::State<'_, mobile::AppState>, direction: String) {
...
#[tauri::command]
fn tick_game(state: tauri::State<'_, mobile::AppState>) -> GameState {
    state.0.lock().unwrap().tick()
}

#[tauri::command]
fn restart_game(state: tauri::State<'_, mobile::AppState>) -> GameState {
    state.0.lock().unwrap().restart();
    state.0.lock().unwrap().get_state()
}
